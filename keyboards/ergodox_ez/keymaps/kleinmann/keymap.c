...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(DE_LESS,KC_1,KC_2,KC_3,KC_4,KC_5,DE_ACUT,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),KC_ESCAPE,KC_A,KC_S,KC_D,KC_F,KC_G,LSFT_T(DE_LPRN),DE_Y,KC_X,KC_C,KC_V,KC_B,MO(1),KC_LCTRL,DE_CIRC,KC_NO,KC_LALT,KC_RGUI,KC_INSERT,KC_HOME,KC_END,KC_SPACE,KC_LSHIFT,TG(3),KC_BSPACE,KC_6,KC_7,KC_8,KC_9,KC_0,DE_SS,TG(2),DE_Z,KC_U,KC_I,KC_O,KC_P,DE_UE,KC_H,KC_J,KC_K,KC_L,DE_OE,DE_AE,MO(1),KC_N,KC_M,KC_COMMA,KC_DOT,DE_MINS,RSFT_T(DE_RPRN),KC_RGUI,KC_RALT,DE_PLUS,DE_HASH,KC_NO,KC_LEFT,KC_RIGHT,KC_UP,KC_DOWN,KC_ENTER,KC_BSPACE),
